...
const NewResponsibilityPage = () => {
    const title = 'Create Responsiblity';
    ...
    return (
      ...
      <Row className="mb-3 g-3">
        ...
        <Col md="6">
        <Select classNamePrefix="react-select" options={options} value={value} onChange={setValue} placeholder="Permissions" />
        </Col> 
...
export default NewResponsibilityPage;
